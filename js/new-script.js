...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Project Filtering - Complete Rewrite
    projectFilters.forEach(filter => {
        filter.addEventListener('click', function() {
            ...
            // Temporarily make moreProjects visible for filtering
            if (wasHidden) {
            ...
            // Apply correct grid layout to both containers
            ...
            if (matchesInMore > 0) {
                // Make more-projects visible and update button text
                if (wasHidden) {
                    moreProjects.classList.add("hidden"); // Add it back, user needs to click button
                }
                viewMoreBtn.textContent = "View More Projects";
                viewMoreBtn.style.display = 'inline-block';
            } else {
                // Hide the button if no extra projects match
                viewMoreBtn.style.display = 'none';
            }
            
            // If more-projects was hidden before, hide it again
            if (wasHidden) {
    ...
    // View More Projects Button - Complete Rewrite
    ...
    if (viewMoreProjectsBtn) {
        viewMoreProjectsBtn.addEventListener('click', function(e) {
            ...
            if (moreProjects.classList.contains("hidden")) {
                ...
                // Make sure all visible cards have correct display
    ...
    // Initialize "View More Projects" functionality
    if (viewMoreProjectsBtn) {
        // Make sure "more-projects" is hidden by default
        const moreProjects = document.getElementById("more-projects");
        if (!moreProjects.classList.contains("hidden")) {
            moreProjects.classList.add("hidden");
        }
