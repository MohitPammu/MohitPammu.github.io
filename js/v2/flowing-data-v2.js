...
document.addEventListener('DOMContentLoaded', () => {
    console.log('Initializing flowing data background...');

    // Configuration - Optimized for better performance
    const config = {
        // Wave configuration - Reduced count for better performance
        waveSets: [
        ...
        // Particle configuration - Reduced count for better performance
     ...
     * Exposed globally for other scripts to call
     */
    ...
    /**
     * Listen for section change events from fullpage scrolling
     */
    ...
    /**
     * Synchronize parallax with sections - exposed globally
     */
