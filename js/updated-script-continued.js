...
document.addEventListener('DOMContentLoaded', () => {
    ...
    projectFilters.forEach(filter => {
        filter.addEventListener('click', function() {
            ...
            if (wasHidden) {
                // Don't actually remove the hidden class yet
                // We're just checking which cards would match
            ...
            // Handle the "View More Projects" button visibility
            if (matchesInMore > 0) {
            ...
            // Re-hide more projects if it was hidden before
            if (wasHidden) {
    ...
    if (viewMoreProjectsBtn) {
        viewMoreProjectsBtn.addEventListener('click', function(e) {
            ...
            if (moreProjects.classList.contains('hidden')) {
                ...
                // Only show cards that match the current filter
    ...
    // Make sure the more-projects section is hidden by default
    const moreProjects = document.getElementById('more-projects');
